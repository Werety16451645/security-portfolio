...
| Системные файлы / Конфигурации | ⭐⭐⭐⭐ | .env, .git, бэкапы, Sentry |
...
| 5 | Яндекс | Диск | Information Disclosure (CSP) | 🟡 Medium | 📤 Отправлен |
| 6 | Яндекс | Паспорт | OAuth Open Redirect + CRLF Injection | 🔴 Critical | 📤 Отправлен |
...
Missing Input Validation (50+) · Missing Events · Конфликты селекторов (30+) · Missing zero-address (10+) · nonce без проверок (40+) · **Яндекс: Open Redirect (4 сервиса)** · **Сбер: отсутствие CSP/HSTS**

---

## 📁 Проекты

**Lido DAO** (24) · **Paxos** (24) · **Wormhole** (10) · **Aave V4** (20) · **Яндекс** (8 находок) · **Ozon** (4) · **Сбер** (3) · **Pachca.com** (2) · **VK/RuStore** (2) · Metric DEX · DRE App · LayerZero Stellar · Phantom · Nubank
...
| 🦀 Rust/Solana | Anchor, SPL Token, minter-controller |
...
- [x] Rust/Solana аудит
- [x] Damn Vulnerable DeFi (12 уровней)
- [ ] Первая выплата 💰
...
*Обновлено: 17 июля 2026 — OAuth CRLF, Rust/Solana, Damn Vulnerable DeFi, 6 отчётов*
